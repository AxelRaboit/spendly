...
<![endif]-->
<!--[if !mso]><!-->
<div style="width: 48px; height: 48px; background: linear-gradient(135deg, #6366f1, #4f46e5); background-color: #4f46e5; border-radius: 11px; line-height: 48px; text-align: center; font-family: 'Figtree', 'Segoe UI', sans-serif; font-size: 28px; font-weight: 700; color: #ffffff;">S</div>
<!--<![endif]-->
</td>
</tr>
<tr>
