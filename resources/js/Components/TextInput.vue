...
<template>
    <div v-if="isPasswordField" class="relative" :class="$attrs.class">
        <input
            ...
            class="w-full px-3 py-2 pr-10 border border-gray-700 rounded-md bg-gray-700 text-gray-100 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
        >
        <button
            type="button"
            tabindex="-1"
