...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class="space-y-4">
            ...
            <div v-if="rules.data.length > 0" class="bg-surface border border-line/60 rounded-2xl overflow-hidden">
                        ...
                        <tr v-for="rule in rules.data" :key="rule.id" class="hover:bg-surface-2/50 transition-colors">
                            ...
                            <td class="px-4 py-3">
                                <select
                                    ...
                                    class="bg-surface-2 text-primary rounded px-2 py-1 border border-line text-sm focus:border-indigo-500 focus:outline-none"
