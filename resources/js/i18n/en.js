export default {
    ...
    auth: {
        ...
        forgotPassword: {
            ...
            instructions: 'Forgot your password? No problem. Just let us know your email address and we will email you a password reset link.',
        ...
        verifyEmail: {
            ...
            instructions: "Thanks for signing up! Before getting started, could you verify your email address by clicking on the link we just emailed to you?",
